...
" preview (keep cursor in QuickFix window after select file)
noremap <buffer>p  <CR>zz<C-w>p

" display total number of result in statusline
setlocal statusline+=\ %L

" loop cursor top/bottom
...
" delete unnecessary line even in QuickFix window
